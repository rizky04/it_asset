            ...
            <div class="modal-body">
                    <form action="{{ route('createLokasi') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_lokasi" placeholder="lokasi" required>
                        </div>
...
<div class="modal fade" id="modalEditKategori{{ $kt->id }}" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    <form action="{{ route('updateLokasi', $kt->id) }}" method="post">
                        @csrf

                        <input type="hidden" class="form-control" name="id" value="{{ $kt->id }}">

                        <div class="form-group">
                            <label for="nama_kategori">Nama lokasi</label>
                            <input type="text" class="form-control" name="nama_lokasi" value="{{ $kt->nama_lokasi }}">
                        </div>
...
<div class="modal fade" id="modalDeleteKategori{{ $kg->id }}" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    <form action="{{ route('deleteLokasi', $kg->id) }}" method="get">
                        @csrf
                        <input type="hidden" class="form-control" value="{{ $kg->id }}">
                        <div class="form-group">
                            <label for="nama">Data Akan dihapus</label>
                            <input type="text" class="form-control" value="{{ $kg->nama_lokasi }}" readonly>
                        </div>
