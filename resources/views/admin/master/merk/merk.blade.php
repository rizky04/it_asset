    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    <form action="{{ route('createMerk') }}" method="post">
                        @csrf
                        <div class="form-group">
                            <label for="Kategori">Nama Kategori</label>
                            <input type="text" class="form-control" name="nama_merk" placeholder="merk" required>
                        </div>
...
<div class="modal fade" id="modalEditKategori{{ $kt->id }}" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    <form action="{{ route('updateMerk', $kt->id) }}" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_merk" value="{{ $kt->nama_merk }}">
                        </div>
...
<div class="modal fade" id="modalDeleteKategori{{ $kg->id }}" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    <form action="{{ route('deleteMerk', $kg->id) }}" method="get">
                        @csrf
                        <input type="hidden" class="form-control" value="{{ $kg->id }}">
                        <div class="form-group">
                            <label for="nama">Data Akan dihapus</label>
                            <input type="text" class="form-control" value="{{ $kg->nama_merk }}" readonly>
                        </div>
